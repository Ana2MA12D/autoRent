...
<head>
    ...
    <title>Редактировать заказ аренды</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-5">
    <h1>Редактировать заказ аренды</h1>
    ...
    <form action="{{ route('rental_orders.update', $rentalOrder->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="client_id" name="client_id" required>
                ...
                @foreach($clients as $client)
                    <option value="{{ $client->id }}" {{ $rentalOrder->client_id == $client->id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="pickup_date" name="pickup_date"
                   value="{{ $rentalOrder->pickup_date }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="dropoff_date" name="dropoff_date"
                   value="{{ $rentalOrder->dropoff_date }}" required>
        </div>
